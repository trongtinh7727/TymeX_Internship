...
android {
    namespace = "com.iiex.currencyconverter"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.iiex.currencyconverter"
        minSdk = 22
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
        buildConfigField("String", "EXCHANGE_API_KEY", "${apikeyProperties["EXCHANGE_API_KEY"]}")
